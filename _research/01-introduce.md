...
Our research is focused on advancing the field of software verification, which is crucial for ensuring the reliability, security, and safety of software systems. Software verification involves the use of automated techniques to check that software behaves as expected and meets its specifications. This is particularly important in critical systems where failures can have severe consequences, such as in aerospace, automotive, and healthcare industries.
